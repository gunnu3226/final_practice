...
public class QFoodReview extends EntityPathBase<FoodReview> {
    ...
    private static final long serialVersionUID = -2023038900L;
    ...
    public final com.sparta.finalpractice.food.entity.QFood food;
    ...
    public QFoodReview(Class<? extends FoodReview> type, PathMetadata metadata, PathInits inits) {
        ...
        this.food = inits.isInitialized("food") ? new com.sparta.finalpractice.food.entity.QFood(forProperty("food"), inits.get("food")) : null;
